...
This repository contains a production-grade full-stack application developed while following Neil Cummings' course on modern web development. It features a robust .NET 9 backend API integrated with an Angular 20 frontend, leveraging Entity Framework Core for seamless data access and persistence.ating Application
